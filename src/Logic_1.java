public class Logic_1 {
    ...
    class CigarParty {
        ...
        public boolean cigarParty(int cigars, boolean isWeekend) {
            return cigars < 40 ? false :
                    isWeekend == true ? true :
                            cigars <= 60 ? true : false;
        }
    }
    ...
    class DateFashion {
        ...
        of your date's clothes. The result getting the table is encoded as an int value with 0=no, 1=maybe, 2=yes.
    ...
    class AnswerCell {
        ...
        morning you only answer if it is your mom calling. In all cases, if you are asleep, you do not answer.
    ...
    class FizzString2 {
        ...
        is divisible by 5 use "Buzz", and if divisible by both 3 and 5, use "FizzBuzz". Note: the % "mod" operator
    ...
    class InOrderEqual {
        ...
        or 5 6 7, but not 6 5 7 or 5 5 7.
    ...
    class MaxMod5 {
        ...
        However, in all cases, if the two values are the same, return 0. Note: the % "mod" operator
    ...
    class GreenTicket {
        ...
        from each other, the result is 0.
    ...
    class ShareDigit {
        ...
        public boolean shareDigit(int a, int b) {
            ...
            return aLeft == bLeft ? true :
                    aLeft == bRight ? true :
                            aRight == bLeft ? true :
                                    aRight == bRight ? true : false;
        }
    }
    ...
    class SumLimit {
        ...
        If the sum has more digits than a, just return a without b. (Note: one way to compute the number of digits of a non-negative int n is to convert it to a string with
