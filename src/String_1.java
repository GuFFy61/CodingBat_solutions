public class String_1 {
    ...
    class FirstTwo {
        ...
        yields "He". If the string is shorter than length 2, return whatever
        there is, so "X" yields "X", and the empty
    ...
    class Right2 {
        ...
        the last 2 chars are moved to the start. The string length will be at least 2.
    ...
    class MiddleTwo {
        ...
        middle two chars, so the string "string" yields "ri". The string length will be at least 2.
    ...
    class LastChars {
        ...
        public String lastChars(String a, String b) {
            ...
            if (a.length() > 0 && b.length() > 0) {
                str = a.substring(0,1) + b.substring(b.length() - 1);
            }
            else if (a.length() < 1 && b.length() > 0) {
                str = "@" + b.substring(b.length() - 1);
            }
    ...
    class LastTwo {
        ...
        public String lastTwo(String str) {
            if (str.length() > 1) {
                ...
                return str = str.substring(0, str.length() - 2) + s2 + s1;
            }
            return str;
        }
    }
    ...
    class StartWord {
        ...
        not need to match exactly. On a match, return the front of the string,
