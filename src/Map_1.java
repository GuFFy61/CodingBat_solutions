...
public class Map_1 {
    ...
    class MapAB {
        ...
        not contain the "a" and "b" keys. If both keys are present,
    ...
    class Topping2 {
        ...
        the map as follows: if the key "ice cream" has a value, set that as the value for the key "yogurt" also.
    ...
    class MapAB4 {
        ...
        public Map<String, String> mapAB4(Map<String, String> map) {
            if (map.containsKey("a") && map.containsKey("b")) {
                int aValueLen = map.get("a").length();
                int bValueLen = map.get("b").length();

                if (aValueLen > bValueLen) {
                    map.put("c", map.get("a"));
                } else if (aValueLen < bValueLen) {
                    map.put("c", map.get("b"));
                } else {
                    map.put("a", "");
                    map.put("b", "");
