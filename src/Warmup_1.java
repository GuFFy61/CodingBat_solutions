public class Warmup_1 {
    ...
    are on vacation. We sleep in if it is not a weekday or we're on vacation.
    ...
    */
    ...
    class Close10 {
        ...
        to the value 10, or return 0 in the event of a tie. Note that Math.abs(n)
        ...
        public int close10(int a, int b) {
            int close1 = Math.abs(a - 10);
            int close2 = Math.abs(b - 10);
            if (close1 < close2) {
                return a;
            }
            if (close2 < close1) {
    ...
    class EndUp {
        ...
        public String endUp(String str) {
            if (str.length() > 3) {
                String upBack = str.substring(str.length() - 3, str.length()).toUpperCase();
