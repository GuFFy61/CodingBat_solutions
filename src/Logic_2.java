public class Logic_2 {
    ...
    class LuckySum {
        ...
        count towards the sum and values to its right do not count. So for example,
    ...
    class EvenlySpaced {
        ...
        if the three values are evenly spaced, so the difference between small and medium
